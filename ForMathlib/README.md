...
| `Analysis/InnerProductSpace/Orthonormal.lean` | `Mathlib/Analysis/InnerProductSpace/Orthonormal.lean` | `inner_linearCombination_linearCombination` — inner product of two `Finsupp.linearCombination`s expanded over `⟪v i, v j⟫` (the Gram-rigidity algebraic core; no Gram matrix) |
