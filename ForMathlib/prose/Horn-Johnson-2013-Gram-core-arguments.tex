...
% factorization A = B^* B).
%
% This file is not a transcription of the book.  It is an independently written
% digest of the exact mathematical arguments, with attribution and precise
...
arguments, not a transcription.  Section and result numbers refer to the 2nd
edition.
\end{center}
