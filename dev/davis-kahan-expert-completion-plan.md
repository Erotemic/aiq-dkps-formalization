...
OP3.A (Opus, unblocked) ─→ OP3.B (Opus)
G2.2a spectral repulsion (Opus, routed v12 — start anytime)
...
statement.  Startable-now Opus items: **OP3.A (→ OP3.B), G2.2a**.  Remaining
Fable items: the two headline proofs, **G2.2b** and **G3** — the last two
...
| 3′ | G2.2a | Spectral repulsion: off-diagonal perturbations avoid the gap | 3/5 | **Opus**, routed v12, start anytime |
