...
4. ▶ **R — Mathlib-readiness pass** (active). R1 ✅, R1b ✅ done. Next R2 → R3 → R3b, with R2b/R4/R5 as the Fable-leaning follow-ups and R6 decisions surfaced to the user before finalizing.
