...
\noindent Companion note to \href{https://github.com/AIQ-Kitware/aiq-dkps-formalization/blob/b270e16975e77e13e9ae289f38572eb8d0ff3910/ForMathlib/Analysis/InnerProductSpace/DavisKahan.lean}{ForMathlib/Analysis/InnerProductSpace/DavisKahan.lean} and its sibling files under \href{https://github.com/AIQ-Kitware/aiq-dkps-formalization/tree/b270e16975e77e13e9ae289f38572eb8d0ff3910/ForMathlib/Analysis/InnerProductSpace}{ForMathlib/Analysis/InnerProductSpace/}, part of a larger formalization effort at \href{https://github.com/AIQ-Kitware/aiq-dkps-formalization}{github.com/AIQ-Kitware/aiq-dkps-formalization}.
...
Theorem~\ref{thm:ladder}.  Five of the gaps it recorded have since been closed;
...
Both remaining items are deliberately deferred; each downstream consumer in
this repository is already served by the Frobenius and operator-norm results
above.  A full roadmap for closing them --- the Davis--Kahan~III quartet
...
\item \emph{Unitarily invariant norms (deferred by design).}  Symmetric gauge
  functions, Ky Fan norms, Fan dominance, and the part~III $\sin\Theta$
  theorem for every unitarily invariant norm.  A Mathlib-sized library on its
  own; nothing downstream in this repository consumes it.
\end{enumerate}
