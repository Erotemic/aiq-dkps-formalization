...
perturbation, Procrustes alignment, measurable alignment events, and
...
\begin{enumerate}[leftmargin=*]
  ...
  control, Procrustes alignment, and Gram-realization lemmas.
...
an approximate isometry into a genuine isometry.  Gram and Procrustes lemmas
...
\file{Procrustes.lean}, \file{GramRealization.lean},
...
bounds, Gram-matrix and Procrustes rigidity, quantitative near-isometry and
...
perturbation, raw-stress MDS stability, Procrustes alignment, measurable
...
\begin{itemize}[leftmargin=*]
  ...
  \item Acharyya2024 consistency: \decl{fixed_models_fixed_queries_consistency},
  \decl{fixed_models_growing_queries_consistency},
  \decl{growing_models_growing_queries_consistency}.
